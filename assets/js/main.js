    ...
    if (form) {
        form.addEventListener('submit', function (e) {
            ...
            if (errors.length) {
                ...
                errorsBox.innerHTML = '<div class="gl-form-ok">Online booking is coming soon — call <a href="tel:+254707232167">+254 707 232167</a> or WhatsApp us to reserve your seat.</div>';
            }
        });
    }
